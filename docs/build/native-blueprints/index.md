...
Instantiating a native component is usually done through a dedicated [manifest instruction](/docs/manifest-instructions), though this is not always the case.
