...
The resolved links are returned by the <a href="/api-reference/gateway-api-specs.html#operation/StateEntityDetails">/state/entity/details endpoint</a> on the [Gateway API](../../integrate/network-apis/index.md).
