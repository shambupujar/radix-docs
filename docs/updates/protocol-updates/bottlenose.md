...
- **Display Name:** Bottlenose
- **Logical Name:** `bottlenose`
- **Mainnet Enactment:**
  - **Status:** Enacted <!-- OR Pending OR In Development -->
  - **Epoch:** `105353` <!-- OR TBC -->
  - **Timestamp:** `2024-06-07T10:31:00Z` <!-- OR TBC -->

## Main Changes

- New [Account Locker native blueprint](../../build/native-blueprints/locker.md)
...
- [Scrypto v1.2.0](../scrypto-updates/scrypto-v1-2-0.md)

## Libraries & SDKS

*See later [protocol updates](index.md).*
